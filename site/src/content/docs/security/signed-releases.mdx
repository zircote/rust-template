...
description: "Release signing with Cosign and SLSA provenance."
---
...
The canonical verification commands live in [SECURITY.md](https://github.com/zircote/rust-template/blob/main/SECURITY.md#verifying-release-artifacts). This document explains the architecture and expands on each artifact type.
...
The central signer also attaches SBOM and vulnerability-report attestations; see [SECURITY.md](https://github.com/zircote/rust-template/blob/main/SECURITY.md#verifying-release-artifacts) for those commands.
