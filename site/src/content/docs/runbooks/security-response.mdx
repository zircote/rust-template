...
Runbook for handling security vulnerabilities in rust-template. Based on the project's [Security Policy](https://github.com/zircote/rust-template/blob/main/SECURITY.md).
