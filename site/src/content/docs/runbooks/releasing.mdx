...
- [ ] **Attestations verify** from an independent machine (full reference: [SECURITY.md](https://github.com/zircote/rust-template/blob/main/SECURITY.md#verifying-release-artifacts)):
  ```bash
...
- **Attestations:** SLSA build provenance + CycloneDX SBOM attestation per binary, single `{bin}-{version}-checksums.txt` file; verify per [SECURITY.md](https://github.com/zircote/rust-template/blob/main/SECURITY.md#verifying-release-artifacts)
