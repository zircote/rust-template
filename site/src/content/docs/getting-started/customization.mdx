---
title: "Customization"
description: "How to customize the rust-template for your project."
---
...
For detailed guidance on property-based testing strategies, see [docs/testing/PROPERTY-BASED-TESTING.md](/rust-template/testing/property-based-testing/).
