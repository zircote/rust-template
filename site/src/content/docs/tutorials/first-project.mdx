...
lives in the [GitHub Template Features](/rust-template/getting-started/github-template-features/)
reference.)
...
[CI Troubleshooting](/rust-template/runbooks/ci-troubleshooting/) runbook maps each
failure to its fix.
...
- **By hand:** the [Customization](/rust-template/getting-started/customization/) guide walks
...
in the [Releasing](/rust-template/runbooks/releasing/) runbook. Read it before your first
real release.
...
| If you want to… | Read |
|---|---|
| Follow a task-focused setup checklist (secrets, signing, options) | [Getting Started](/rust-template/getting-started/getting-started/) (how-to) |
| Configure `Cargo.toml`, features, profiles, and lints | [Configuration](/rust-template/getting-started/configuration/) (how-to) |
| Add modules, go library-only, adjust lints, customize Docker | [Customization](/rust-template/getting-started/customization/) (how-to) |
| Have AI scaffold a whole project for you | [Copilot Jumpstart](/rust-template/getting-started/copilot-jumpstart/) (how-to) |
| Look up exactly what every CI workflow does | [CI Workflows](/rust-template/workflows/ci-workflows/) (reference) |
| See what copies when you "Use this template" | [GitHub Template Features](/rust-template/getting-started/github-template-features/) (reference) |
| Fix a failing CI check | [CI Troubleshooting](/rust-template/runbooks/ci-troubleshooting/) (how-to) |
| Cut and verify a release | [Releasing](/rust-template/runbooks/releasing/) (how-to) |
