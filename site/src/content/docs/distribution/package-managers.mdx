...
description: "Distribution through Homebrew, Snap, MSI, deb, and rpm."
---
...
See [SECURITY.md](https://github.com/zircote/rust-template/blob/main/SECURITY.md#verifying-release-artifacts) for the full verification reference.
